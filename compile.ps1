...
arduino-cli compile --fqbn esp32:esp32:esp32s3:PartitionScheme=huge_app,CDCOnBoot=cdc --output-dir mobile_app\bin_v2 "1.69 Luna Firmware\1.69 Luna Firmware.ino"
