...
// Pin Configurations for ESP32-C3 SuperMini with 1.8" ST7735 TFT SPI Display (8-Pin)
...
#define TFT_CS 2      // Chip Select pin (CS pin for 8-pin display)
...
// ST7735 Display Settings (Resolution: 128x160)
