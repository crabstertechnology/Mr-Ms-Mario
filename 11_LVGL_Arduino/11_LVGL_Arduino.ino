...
void setup() {
  ...
  // Create and play Lottie animation from JSON data
  lv_obj_t * lottie_anim = lv_rlottie_create_from_raw(lv_scr_act(), 240, 280, lottie_json);
